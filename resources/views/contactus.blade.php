...
<div class="container">
	...
	<div class="col-12 col-md-6">
		<form class="form-horizontal" method="POST" action="{{ action('Api\MailController@sendMail') }}">
			{{ csrf_field() }} 
			<div class="form-group form-inline">
			<label for="Name">姓名： </label>
			<input type="text" class="form-control" id="ename"  placeholder="" name="name" required>
		</div>

		<div class="form-group form-inline">
			<label for="sender">Email或电话: </label>
			<input type="text" class="form-control" id="sender"  placeholder="" name="sender" required>
		</div>
